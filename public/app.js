...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 24, category: 'technical', title: 'robots.txt', score: 10, cadence: 'Content Engine pipeline run + launch QA + crawl-policy monitoring', fulfillment: 'Robots.txt File Management / Sitemap / GSC Indexing Audit / Content Engine', source: 'deliverables/technical/24-robots-txt/README.md; Vercel + GitHub robots.txt route; WordPress + SiteGround FTP HTML-root route; ClickUp: 13. Robots.txt File Managment; Robots.txt configuration; 9. Sitemap; Sitemap generation and submit to GSC; 7. GSC Indexing Audit; Google robots.txt introduction; Create and submit a robots.txt file; robots.txt specification interpretation; Block indexing with noindex; Search Console robots.txt report; deliverables/technical/22-google-search-console/README.md; deliverables/technical/23-xml-sitemap/README.md; deliverables/technical/28-duplicate-content-canonicals/README.md', sopStatus: 'Fully automated', summary: 'Run robots.txt generation, deployment, validation, and monitoring inside the Content Engine pipeline with routing for Vercel + GitHub stacks and WordPress + SiteGround FTP deployments.', human: 'No routine human gate. Exception review handles missing platform access, conflicting crawl strategy, plugin/root-file conflicts, emergency bot-control decisions, or staging/privacy uncertainty.', ai: 'Route by platform, generate robots.txt from target URLs and SEO strategy for Vercel + GitHub stacks, upload WordPress robots.txt to the SiteGround HTML root by FTP, validate live plaintext output, and route exceptions.' },

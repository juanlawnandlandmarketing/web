...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 10, category: 'off-page', title: 'Citation Building - Onboarding', score: 4, cadence: 'One-time setup', fulfillment: 'Citation Building', source: 'deliverables/off-page/10-citation-building-onboarding/README.md; deliverables/off-page/11-citation-monitoring/README.md; deliverables/off-page/13-backlink-business-directories/README.md; deliverables/on-page/09-competitor-analysis/README.md; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/35-gbp-link-on-website/README.md', sopStatus: 'SOP documented', summary: 'Build the onboarding citation baseline by locking approved NAP data, prioritizing directory sources, preparing submission packets, tracking blockers, and handing clean records into monitoring.', human: 'Approve the NAP source of truth, handle accounts, payments, verification, duplicate claims, and final submissions where platforms require manual ownership.', ai: 'Compare website/GBP/client data, prepare citation packets, find existing listings and duplicates, tier directories, draft submission notes, and verify public listing URLs.' },

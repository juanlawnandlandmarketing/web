...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 25, category: 'technical', title: 'Domain Migration & 301 Redirects', score: 7, cadence: 'Migration launch + monthly redirect QA', fulfillment: 'Technical SEO Audit / SEO Audit Ahrefs / GSC Indexing Audit / Domain Migration', source: 'deliverables/technical/25-301-redirects/README.md; Vercel + GitHub AI Agent redirect mapping; WordPress + Claude mapping + Rank Math manual deployment; ClickUp: 2. SEO Audit Ahrefs; Introduction to Ahrefs Health Score and Site Audit; Issues definition; 7. GSC Indexing Audit; 1. Rank Math & SEO Plugin Initial Setup; 2. Onsite Core Content Optimization; 9. Sitemap; Google redirects and Search; Google site moves with URL changes; GSC Change of Address tool; deliverables/technical/20-rank-math-setup/README.md; deliverables/technical/22-google-search-console/README.md; deliverables/technical/23-xml-sitemap/README.md; deliverables/technical/28-duplicate-content-canonicals/README.md; deliverables/on-page/05-internal-linking/README.md', sopStatus: 'Platform-routed SOP documented', summary: 'Route migration redirects by platform: Vercel + GitHub stacks use AI Agents to map old URLs to new targets and deploy repo redirect rules automatically; WordPress sites use Claude to generate the mapping strategy before manual Rank Math deployment.', human: 'Manually create WordPress redirects inside Rank Math, review Claude maps before entry, handle non-Vercel server/admin systems, and decide rebuild vs redirect vs 404/410 for strategic edge cases.', ai: 'Ingest old URLs and new target inventories, determine old-to-new mappings from slug/title/content/service/city signals, automate Vercel + GitHub redirect config, generate Claude-backed WordPress maps, and verify live redirects.' },

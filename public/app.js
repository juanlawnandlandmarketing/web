...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 3, category: 'on-page', title: 'Service Area Pages', score: 9, cadence: 'Content-engine driven onboarding + expansion campaigns', fulfillment: 'Onsite Core Content Optimization / Content Engine / SEO Images Optimization', source: 'deliverables/on-page/03-service-area-pages/README.md; seo/automation/STEP_5_SITE_ARCHITECTURE.md; seo/automation/STEP_6A_CONTENT_BRIEFS_P1.md; Ground Control brand references', sopStatus: '90% automated', summary: 'Use the content engine to turn city/service keyword targets into local page briefs, copy, metadata, FAQs, internal links, schema guidance, brand-aligned image prompts, alt text, and QA packets.', human: 'Handle exception-review items: service coverage, city accuracy, local proof, sensitive claims, page-builder safety, consolidation decisions, and generated imagery when Ground Control references are incomplete or risky.', ai: 'Map city/service keywords to URLs, audit existing area pages, draft or rewrite local copy, generate metadata/FAQs/link recommendations, pull Ground Control image references, and flag thin or overlapping city pages.' },

...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 2, category: 'on-page', title: 'Service Pages', score: 9, cadence: 'Content-engine driven onboarding + as-needed updates', fulfillment: 'Onsite Core Content Optimization / Content Engine / SEO Images Optimization', source: 'deliverables/on-page/02-service-pages/README.md; seo/automation/STEP_5_SITE_ARCHITECTURE.md; seo/automation/STEP_6A_CONTENT_BRIEFS_P1.md; Ground Control brand references', sopStatus: '90% automated', summary: 'Use the content engine to turn the approved keyword map into service-page briefs, copy, metadata, FAQs, internal links, schema guidance, brand-aligned image prompts, alt text, and QA packets.', human: 'Handle exception-review items: service accuracy, sensitive claims, page-builder safety, consolidation decisions, and generated imagery when Ground Control references are incomplete or risky.', ai: 'Map service keywords to URLs, audit existing pages, draft or rewrite copy, generate metadata/FAQs/link recommendations, pull Ground Control image references, and build the publish QA packet.' },
  ...
  { id: 6, category: 'on-page', title: 'Alt Text on Images', score: 9, cadence: 'Every upload + retroactive audit', fulfillment: 'SEO Images Optimization', source: 'deliverables/on-page/06-alt-text/README.md; BLOG-CREATION-PROCESS.md; OPTIMIZATION-PROTOCOL.md; deliverables/on-page/02-service-pages/README.md; deliverables/on-page/03-service-area-pages/README.md; deliverables/on-page/04-blog-content/README.md', sopStatus: 'SOP documented', summary: 'Audit, generate, apply, and verify useful alt text for featured, inline, service, gallery, and managed-site images without keyword stuffing or prompt leakage.', human: 'Review ambiguous visuals, brand/client-photo details, decorative-image decisions, local/service claims, and page-builder edits that cannot be updated safely in bulk.', ai: 'Crawl image inventories, inspect visual/page context, flag missing or weak alt text, draft replacements, update metadata when authorized, and verify live HTML.' },
  { id: 7, category: 'on-page', title: 'Title Tags & Meta Descriptions', score: 7, cadence: 'Onboarding + monthly improvements', fulfillment: 'Onsite Core Content Optimization', source: 'deliverables/on-page/07-title-tags-meta/README.md; OPTIMIZATION-PROTOCOL.md; BLOG-CREATION-PROCESS.md; deliverables/on-page/01-keyword-research/README.md; deliverables/on-page/02-service-pages/README.md; deliverables/on-page/03-service-area-pages/README.md; deliverables/on-page/04-blog-content/README.md', sopStatus: 'SOP documented', summary: 'Audit, rewrite, apply, and verify page titles and meta descriptions so priority URLs have clear intent, truthful local/service targeting, and stronger search snippets.', human: 'Approve major positioning, offer, brand voice, service-area, cannibalization, and sensitive claim changes before broad publishing.', ai: 'Crawl live metadata, flag weak or risky titles/descriptions, draft replacements from keyword/page context, prepare update paths, and verify live HTML.' },
  { id: 8, category: 'on-page', title: 'H1 Optimization', score: 5, cadence: 'One-time audit + launch QA', fulfillment: 'Onsite Core Content Optimization', source: 'deliverables/on-page/08-h1-optimization/README.md; OPTIMIZATION-PROTOCOL.md; BLOG-CREATION-PROCESS.md; deliverables/on-page/02-service-pages/README.md; deliverables/on-page/03-service-area-pages/README.md; deliverables/on-page/04-blog-content/README.md; deliverables/on-page/07-title-tags-meta/README.md', sopStatus: 'SOP documented', summary: 'Audit rendered page headings so priority URLs have one clear visible H1 that matches intent, supports the title tag, and avoids page-builder or template heading clutter.', human: 'Approve visible hero copy, page-builder edits, template-level fixes, service-area wording, and any heading change that affects layout or brand positioning.', ai: 'Crawl rendered pages, detect missing/multiple/hidden/weak H1s, compare headings against page intent, draft replacements, and verify live rendered output.' },
  ...
  { id: 29, category: 'gbp', title: 'Profile Build & Completion', score: 2, cadence: 'One-time setup + quarterly audit', fulfillment: 'Pre-Launch Website GBP Optimization / Post-Launch Website GBP Optimization', source: 'deliverables/gbp/29-gbp-profile-build/README.md; ClickUp: 10. Pre Launch Website GBP Optimization; Accurate Name; Primary Category; Secondary Categories; Description / Bio; Location / Address; Phone Number; Website; Service Area; Business Hours; Add Services; Add Products; Logo; Cover Photo; Additional Images; Social Profile; Q&As Submitted; 11. Post Launch Website GBP Optimization; 5. Clear NAP Listings; Google Business Profile guidelines; Google edit Business Profile docs; Google service area docs; Google verification docs', sopStatus: 'SOP documented', summary: 'Build or audit the Google Business Profile so name, category, address/service area, phone, website, hours, description, services, products, photos, social links, Q&A, and verification status are accurate and compliant.', human: 'Access GBP, approve sensitive edits, confirm business facts, handle verification/re-verification, and apply profile changes that could affect visibility, calls, trust, or policy risk.', ai: 'Compare GBP fields against approved source data, draft descriptions/services/products/Q&A, flag NAP or completion gaps, prepare photo/file recommendations, and build update packets.' },
  { id: 30, category: 'gbp', title: 'GBP Categories', score: 3, cadence: 'Onboarding + quarterly audit', fulfillment: 'Pre-Launch Website GBP Optimization / Post-Launch Website GBP Optimization / GBP Audit and Image Post', source: 'deliverables/gbp/30-gbp-categories/README.md; ClickUp: Primary Category; Secondary Categories; 10. Pre Launch Website GBP Optimization; Add Services; Services audit; Updating Service Descriptions; 11. Post Launch Website GBP Optimization; Google choose business category docs; Google Business Profile guidelines; Google edit Business Profile docs; Google add/edit services docs; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/36-gbp-attributes/README.md', sopStatus: 'SOP documented', summary: 'Choose and audit primary and secondary GBP categories that describe the real business, match approved services, reflect true competitors, and avoid loose ranking-chase misclassification.', human: 'Approve category choices, primary-category changes, removals, and any category shift that could affect visibility, verification, business positioning, services, or attributes.', ai: 'Compare client services, website pages, current GBP fields, and competitor categories; flag risky or irrelevant categories; prepare category recommendation packets and downstream handoffs.' },
  { id: 31, category: 'gbp', title: 'Weekly GBP Posts', score: 8, cadence: 'Weekly / annual scheduling', fulfillment: 'GBP Audit and Image Post', source: 'deliverables/gbp/31-gbp-weekly-posts/README.md; ClickUp: 1. GBP Audit and Image Post; Additional Images; Cover Photo; Add Services; Add Products; Q&As Submitted; Google create/manage Business Profile posts docs; Google posts content policy; Google Business Profile LocalPost API; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/30-gbp-categories/README.md; deliverables/gbp/33-gbp-photo-management/README.md', sopStatus: 'SOP documented', summary: 'Create, schedule, publish, and verify weekly Google Business Profile posts from approved services, seasonal demand, blogs, press releases, photos, offers, and events without phone stuffing or unsupported claims.', human: 'Approve offers, discounts, unusual promotions, sensitive claims, client-specific announcements, image rights, and any live publishing when GBP access or policy risk is involved.', ai: 'Draft post calendars and copy, select themes and CTAs, prepare media/URL packets, check policy risks, create or schedule posts through the API when authorized, and verify live/pending/rejected status.' },
  ...
  { id: 34, category: 'gbp', title: 'Q&A Management', score: 6, cadence: 'Setup + monthly monitoring', fulfillment: 'GBP Audit and Image Post / Pre-Launch Website GBP Optimization', source: 'deliverables/gbp/34-gbp-qa-management/README.md; ClickUp: Q&As Submitted; 1. GBP Audit and Image Post; FAQ Schema for blog post; Add Services; Add Products; GBP Q&A Generator Assistant; Google Q&A API discontinuation docs; Google Maps answer questions help; Google Maps UGC policy; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/31-gbp-weekly-posts/README.md', sopStatus: 'SOP documented', summary: 'Research, draft, approve, manually verify, and repurpose GBP/Maps Q&A content while accounting for Google’s discontinued Q&A API and changing Q&A surfaces.', human: 'Approve every public question and answer, confirm service/pricing/service-area facts, handle sensitive or policy-risk Q&A, and manually post or verify where the current Google interface allows it.', ai: 'Research People Also Ask and customer-question themes, draft concise approved Q&A packets, flag risk, track feature availability, and route approved content into FAQ/schema, posts, pages, or support materials.' },
  { id: 35, category: 'gbp', title: 'GBP Link on Website', score: 2, cadence: 'One-time setup + launch QA', fulfillment: 'Clients Reviews Integration / Post-Launch Website GBP Optimization', source: 'deliverables/gbp/35-gbp-link-on-website/README.md; ClickUp: 4. Clients Reviews Integration; How it works; 11. Post Launch Website GBP Optimization; Website; Verify NAP in website and GBP; 3. Review Generation Strategy; Review check; Google Business Profile ask-for-reviews docs; Google Maps URLs docs; Google Place IDs docs; Google Maps UGC policy; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/32-gbp-review-replies/README.md', sopStatus: 'SOP documented', summary: 'Verify, place, and QA the correct Google Business Profile, Maps, directions, or review request link on the client website without wrong-location links, review gating, or hidden-address mistakes.', human: 'Confirm the correct GBP/review URL, approve placement and review CTA language, edit WordPress/theme areas, and resolve any profile, NAP, location, or access mismatch before publishing.', ai: 'Crawl website pages for Google links, flag missing/wrong/broken/stale links, compare visible NAP against GBP, check review CTA risk, and prepare placement/QA reports.' },
  { id: 36, category: 'gbp', title: 'GBP Attributes', score: 3, cadence: 'Quarterly / category-change review', fulfillment: 'GBP Audit and Image Post / Pre-Launch Website GBP Optimization / Post-Launch Website GBP Optimization', source: 'deliverables/gbp/36-gbp-attributes/README.md; ClickUp: 1. GBP Audit and Image Post; Initial Audit; Services audit; 10. Pre Launch Website GBP Optimization; 11. Post Launch Website GBP Optimization; Primary Category; Secondary Categories; Add Services; Add Products; Business Hours; Service Area; Location / Address; Verify NAP in website and GBP; Google manage business attributes docs; Google Business Profile Attributes API; Google locations.getAttributes/updateAttributes docs; Google attributes.list docs; deliverables/gbp/29-gbp-profile-build/README.md; deliverables/gbp/30-gbp-categories/README.md', sopStatus: 'SOP documented', summary: 'Audit, approve, update, and verify category-dependent GBP attributes so accessibility, amenities, service options, planning, payments, and identity/highlight claims match the real business.', human: 'Confirm sensitive or public-facing claims, approve accessibility/identity/service-option attributes, handle live GBP edits, and resolve category, verification, address, or policy risk.', ai: 'Pull current/available attributes when access exists, compare them against services, products, website, reviews, and client facts, flag risky claims, and prepare approval/QA packets.' },

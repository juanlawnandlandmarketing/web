...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 21, category: 'technical', title: 'Schema Markup', score: 10, cadence: 'Content Engine pipeline run + launch QA + schema refresh', fulfillment: 'Schema Implementation / Content Engine / Technical SEO Audit', source: 'deliverables/technical/21-schema-markup/README.md; DataForSEO API; Content Engine pipeline; ClickUp: 8. Schema Implementation; Local Business Schema; FAQ Schema for blog post; Service Schema for service page; Google structured data guidelines; Google structured data gallery; Google Local Business structured data; Google Breadcrumb structured data; Schema.org; Rank Math schema documentation; deliverables/technical/20-rank-math-setup/README.md; deliverables/on-page/02-service-pages/README.md; deliverables/on-page/03-service-area-pages/README.md; deliverables/on-page/04-blog-content/README.md; deliverables/technical/23-xml-sitemap/README.md', sopStatus: 'Fully automated', summary: 'Run schema markup inside the Content Engine pipeline by combining generated content data with live DataForSEO metrics, page-role classification, crawl output, and structured-data validation.', human: 'No routine human gate. Exception review handles missing approved entity facts, contradictory NAP/service-area data, sensitive claims, access blockers, or schema source-of-truth conflicts.', ai: 'Pull generated content packets and DataForSEO metrics, classify page roles, select schema types, generate JSON-LD or Rank Math field packets, validate output, detect duplicates, and route exceptions.' },

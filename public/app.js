...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 23, category: 'technical', title: 'XML Sitemap', score: 10, cadence: 'Content Engine pipeline run + launch QA + monthly monitoring', fulfillment: 'Sitemap / GSC Indexing Audit / Content Engine / Rank Math', source: 'deliverables/technical/23-xml-sitemap/README.md; Vercel + GitHub sitemap route; WordPress + Rank Math sitemap route; ClickUp: 9. Sitemap; Sitemap generation and submit to GSC; 7. GSC Indexing Audit; Download the post and page sitemap; Google sitemap overview; Build and submit a sitemap; Search Console Sitemaps report; robots.txt Sitemap directive; deliverables/technical/20-rank-math-setup/README.md; deliverables/technical/22-google-search-console/README.md; deliverables/technical/24-robots-txt/README.md; deliverables/technical/28-duplicate-content-canonicals/README.md', sopStatus: 'Fully automated', summary: 'Run XML sitemap generation, validation, submission prep, and monitoring inside the Content Engine pipeline with platform routing for Vercel + GitHub stacks and WordPress + Rank Math sites.', human: 'No routine human gate. Exception review handles missing platform access, conflicting target URL strategy, Rank Math/plugin conflicts, GSC blockers, or launch/staging uncertainty.', ai: 'Route by platform, generate or update sitemap output from target URLs and SEO strategy for Vercel + GitHub stacks, leverage Rank Math for WordPress sites, validate live XML, compare against GSC when available, and route exceptions.' },

...
const SEO_SYSTEM_CATEGORIES = [
  ...
  { key: 'gbp', label: 'GBP SEO', count: 8, purpose: 'Strengthen local visibility through Google Business Profile completeness, posts, reviews, photos, attributes, and profile hygiene.' },
...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 34, category: 'gbp', title: 'Retired GBP Q&A Workflow', score: 0, cadence: 'Retired / no execution', fulfillment: 'Removed from GBP fulfillment', source: 'deliverables/gbp/34-gbp-qa-management/README.md; legacy ClickUp: Q&As Submitted; replacement routing: Process 02 Service Pages, Process 04 Blog Content, Process 31 Weekly GBP Posts, Process 32 Review Replies, Process 30 Categories, Process 36 Attributes', sopStatus: 'Retired / no execution', summary: 'Do not run the old GBP Q&A workflow. Google Business Profile no longer supports or uses Q&A as an active profile-management surface, so the process is retired and customer-question insights should route to active content, review, post, service, or profile workflows.', human: 'Do not assign, approve, post, answer, monitor, or report on GBP Q&A. Route useful customer-question insights to an active workflow instead.', ai: 'No production automation. Do not generate or manage GBP Q&A packets; only flag obsolete Q&A task references and suggest the correct active workflow.' },

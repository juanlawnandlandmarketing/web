...
const SEO_SYSTEM_ITEMS = [
  ...
  { id: 4, category: 'on-page', title: 'Blog Content Factory Engine', score: 9, cadence: 'Weekly/monthly package runs + phased optimization', fulfillment: 'Blog Content Creation (1/Week) Published + Audited / Content Engine', source: 'deliverables/on-page/04-blog-content/README.md; BLOG-CREATION-PROCESS.md; OPTIMIZATION-PROTOCOL.md; DataForSEO API; n8n Blog Content Factory workflow', sopStatus: '90% automated', summary: 'Run the four-phase Blog Content Factory workflow: AI/n8n research, full content creation, publication, and protocol-driven post-optimization using DataForSEO and client preference inputs.', human: 'Handle exception-review items: sensitive claims, missing client facts, access blockers, consolidation decisions, and brand-sensitive imagery when references are incomplete or risky.', ai: 'Run topic research with n8n and DataForSEO, draft articles, generate brand-compliant image prompts, prepare metadata/internal links/schema, publish when authorized, verify live URLs, and optimize under the protocol.' },
